...
//
// Visual-equivalence probe for the dirty-rectangle compositor. It proves the
// region-composited output is PIXEL-IDENTICAL to a from-scratch full
// recomposite of the same scene:
//
...
//      repainted; everything else is retained from the prior frame).
...
//   5. Assert S1 and S2 are byte-identical: if the region walk ever painted the
//      wrong pixels, S1 would differ from the full S2.
//
